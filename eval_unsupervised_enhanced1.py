...
#DEFAULT_SRDAE_PATH = '/root/autodl-tmp/0-pipei-dinov3/outputs/unsupervised_srdae_512/srdae_model_23_26_29.pth'
#DEFAULT_SRDAE_PATH = '/root/autodl-tmp/0-pipei-dinov3/outputs/unsupervised_srdae_512/srdae_model_26_28v.pth'#srdae_model_22_26_31
DEFAULT_SRDAE_PATH = '/root/autodl-tmp/0-pipei-dinov3/outputs/unsupervised_srdae_512/srdae_model_26_28_40e.pth'#srdae_model_22_26_31

#srdae_model_20_23_27_31
#srdae_model_20_23_26_30

# 特征路径配置
# D2S 模式下的测试集特征路径
FEAT_ROOT_D2S = '/root/autodl-tmp/0-pipei-dinov3/feats_512_test/dinov3_vith16plus'
# S2D 模式下的测试集特征路径
FEAT_ROOT_S2D = '/root/autodl-tmp/0-pipei-dinov3/feats_512_test_s2d/dinov3_vith16plus'

# 融合层配置 (SR-DAE 输入层)
#FUSION_LAYERS = [22, 26, 31] #top-1:  86.02%
#FUSION_LAYERS = [20, 23, 27, 31] #top-1:  86.03%
#FUSION_LAYERS = [20, 23, 26, 30] #top-1:  86.06%
#FUSION_LAYERS = [23, 26, 29] # top-1:  86.53%      100top-1:  86.66%       7.0top-1:  86.54%        3.0top-1:  86.52%    lambda_sparse0.02 top-1:  86.76%   lambda_orth50 top-1:  84.66%
#lambda_sparse0.02 top-1:  86.87%      lambda_sparse: 0.0005 top-1:  86.88%  top-1:  86.91%
FUSION_LAYERS = [26, 28]
INPUT_DIM_B = 2560   # 1280 * 3
#INPUT_DIM_B = 3840   # 1280 * 3
#INPUT_DIM_B = 5120   # 1280 * 3
#LATENT_DIM_B = 1536  # SR-DAE 输出维度 top-1:  86.42%
LATENT_DIM_B = 1280  
#LATENT_DIM_B = 1024  # SR-DAE 输出维度 top-1:  86.28%

# MoE 配置 (Feature A)
MOE_CONFIG_PATH = '/root/autodl-tmp/0-pipei-dinov3/configs/base_moe_shared_specific1.yml'
#MOE_WEIGHT_PATH = '/root/autodl-tmp/0-pipei-dinov3/outputs/base_moe_shared_specific1/300_param28.t'
MOE_WEIGHT_PATH = '/root/autodl-tmp/0-pipei-dinov3/outputs/base_moe_shared_specific1/300_param29.t'
MOE_WEIGHT_PATH = '/root/autodl-tmp/0-pipei-dinov3/outputs/base_moe_shared_specific1/300_param28dec.t'
